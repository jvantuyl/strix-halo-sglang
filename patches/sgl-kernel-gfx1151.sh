...
# Vendored verbatim from sgl-project/sglang docker/patches/sgl-kernel-gfx1151.sh
# at 70b5b03e78612c94f86ac98eb4d2d8d19ceda738 (replaces fork patches 1 and 1b).
# Applied at image-build time; the repo files are left untouched because
# gfx1151 is not a supported SGLang target.
#
# Two changes:
